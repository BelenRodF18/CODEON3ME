                    ...
                    <div class="row g-4 align-items-stretch">
                        <div class="col-lg-8">
                            <div class="p-4 p-md-5 rounded-4 h-100" style="background: rgba(255,255,255,0.04); border: 1px solid rgba(170,250,100,0.2); min-height: 420px;">
                                <img src="../../assets/imagenes/${data.img}" class="img-fluid rounded-4 mb-4" style="width:100%; height:260px; object-fit:cover;">
                                <h1 class="titulos text-uppercase mb-3">${data.titulo}</h1>
                        ...
                        <div class="col-lg-4">
                            <div class="p-4 p-md-5 rounded-4 h-100 d-flex flex-column align-items-center justify-content-center" style="background: rgba(170,250,100,0.08); border: 1px solid rgba(170,250,100,0.2); min-height: 420px;">
                                <img src="../../assets/imagenes/${data.coachImg}" style="width:180px; height:180px; border-radius:50%; object-fit:cover; border: 4px solid #AAFA64; margin-bottom:15px; box-shadow: 0 0 15px rgba(170, 250, 100, 0.3);">
            ...
            if (data) {
                cont.innerHTML = `
                    <div class="row g-4 align-items-stretch">
                        ...
                        <div class="col-12">
                            <div class="card bg-dark text-white border-secondary p-4 p-md-5 rounded-4" style="border-left: 5px solid ${data.color} !important; min-height: 240px;">
